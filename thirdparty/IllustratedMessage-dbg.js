sap.ui.define(['uxc/integration/thirdparty/webcomponents-fiori', 'uxc/integration/thirdparty/i18n2', 'uxc/integration/thirdparty/Illustrations', 'uxc/integration/thirdparty/AccessibilityTextsHelper', 'uxc/integration/thirdparty/parameters-bundle.css', 'uxc/integration/thirdparty/i18n-defaults', 'uxc/integration/thirdparty/Theme', 'uxc/integration/thirdparty/parameters-bundle.css3', 'uxc/integration/thirdparty/Title', 'uxc/integration/thirdparty/Icons', 'uxc/integration/thirdparty/i18n', 'uxc/integration/thirdparty/LocaleData', 'uxc/integration/thirdparty/parameters-bundle.css2'], (function (webcomponentsBase, i18n, Illustrations, AccessibilityTextsHelper, parametersBundle_css, i18nDefaults, Theme, parametersBundle_css$1, Title, Icons, i18n$1, LocaleData, parametersBundle_css$2) { 'use strict';
    ...
    var dialogSvg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="160" height="160" viewBox="0 0 160 160" id="sapIllus-Dialog-BeforeSearch">
...
`;
    ...
    var sceneSvg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="320" height="240" viewBox="0 0 320 240" id="sapIllus-Scene-BeforeSearch">
...
`;
    ...
    var dotSvg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="128" height="128" viewBox="0 0 128 128" id="sapIllus-Spot-BeforeSearch">
    ...
    function IllustratedMessageTemplate() {
        return (parametersBundle_css.jsxs("div", { class: "ui5-illustrated-message-root", children: [parametersBundle_css.jsxs("div", { class: "ui5-illustrated-message-inner", children: [parametersBundle_css.jsx("div", { class: "ui5-illustrated-message-illustration", dangerouslySetInnerHTML: { __html: this.effectiveIllustration || "" } }), parametersBundle_css.jsxs("div", { class: "ui5-illustrated-message-text-and-actions-container", children: [this.hasTitle &&
                                    parametersBundle_css.jsx("div", { part: "title", class: "ui5-illustrated-message-title", children: this.hasFormattedTitle ?
                                            ...
                                            :
                                                parametersBundle_css.jsx(Title, { children: this.effectiveTitleText }) }), this.hasSubtitle &&

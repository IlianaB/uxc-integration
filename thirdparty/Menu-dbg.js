sap.ui.define(['uxc/integration/thirdparty/webcomponents-fiori', 'uxc/integration/thirdparty/event-strict', 'uxc/integration/thirdparty/Theme', 'uxc/integration/thirdparty/i18n2', 'uxc/integration/thirdparty/ListItemTemplate', 'uxc/integration/thirdparty/parameters-bundle.css', 'uxc/integration/thirdparty/Popover2', 'uxc/integration/thirdparty/MenuItem2', 'uxc/integration/thirdparty/ListItemCustom', 'uxc/integration/thirdparty/parameters-bundle.css2', 'uxc/integration/thirdparty/ListItemBase', 'uxc/integration/thirdparty/ResponsivePopover', 'uxc/integration/thirdparty/List', 'uxc/integration/thirdparty/Button2', 'uxc/integration/thirdparty/decline', 'uxc/integration/thirdparty/i18n-defaults2', 'uxc/integration/thirdparty/Icons', 'uxc/integration/thirdparty/i18n', 'uxc/integration/thirdparty/LocaleData', 'uxc/integration/thirdparty/FocusableElements', 'uxc/integration/thirdparty/ListItemAdditionalText.css', 'uxc/integration/thirdparty/Icon', 'uxc/integration/thirdparty/AccessibilityTextsHelper', 'uxc/integration/thirdparty/getEffectiveScrollbarStyle', 'uxc/integration/thirdparty/toLowercaseEnumValue', 'uxc/integration/thirdparty/Title', 'uxc/integration/thirdparty/nav-back', 'uxc/integration/thirdparty/i18n-defaults3', 'uxc/integration/thirdparty/Dialog', 'uxc/integration/thirdparty/information', 'uxc/integration/thirdparty/willShowContent'], (function (webcomponentsBase, eventStrict, Theme, i18n, ListItemTemplate, parametersBundle_css, Popover, MenuItem, ListItemCustom, parametersBundle_css$1, ListItemBase, ResponsivePopover, List, Button, decline, i18nDefaults, Icons, i18n$1, LocaleData, FocusableElements, ListItemAdditionalText_css, Icon, AccessibilityTextsHelper, getEffectiveScrollbarStyle, toLowercaseEnumValue, Title, navBack, i18nDefaults$1, Dialog, information, willShowContent) { 'use strict';
    ...
    function MenuTemplate() {
        return (parametersBundle_css.jsxs(ResponsivePopover, { id: `${this._id}-menu-rp`, class: "ui5-menu-rp", placement: "Bottom", verticalAlign: "Bottom", horizontalAlign: this.horizontalAlign, opener: this.opener, open: this.open, preventInitialFocus: true, hideArrow: true, allowTargetOverlap: true, accessibleName: this.acessibleNameText, onBeforeOpen: this._beforePopoverOpen, onOpen: this._afterPopoverOpen, onBeforeClose: this._beforePopoverClose, onClose: this._afterPopoverClose, children: [this.isPhone &&
                    parametersBundle_css.jsxs("div", { slot: "header", class: "ui5-menu-dialog-header", children: [parametersBundle_css.jsx("div", { class: "ui5-menu-dialog-title", children: parametersBundle_css.jsx("h1", { children: this.headerText }) }), parametersBundle_css.jsx(Button.Button, { icon: decline.decline, design: "Transparent", "aria-label": this.labelClose, onClick: this._close })] }), parametersBundle_css.jsx("div", { id: `${this._id}-menu-main`, children: this.items.length ?
                        ...
                        : this.loading && (parametersBundle_css.jsx(ListItemBase.BusyIndicator, { id: `${this._id}-menu-busy-indicator`, delay: this.loadingDelay, class: "ui5-menu-busy-indicator", active: true })) })] }));
    }

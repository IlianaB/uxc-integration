sap.ui.define(['uxc/integration/thirdparty/webcomponents-fiori', 'uxc/integration/thirdparty/event-strict', 'uxc/integration/thirdparty/i18n2', 'uxc/integration/thirdparty/parameters-bundle.css', 'uxc/integration/thirdparty/query', 'uxc/integration/thirdparty/Popover2', 'uxc/integration/thirdparty/Theme', 'uxc/integration/thirdparty/Avatar', 'uxc/integration/thirdparty/Button2', 'uxc/integration/thirdparty/Icon', 'uxc/integration/thirdparty/Tag', 'uxc/integration/thirdparty/Title', 'uxc/integration/thirdparty/Text', 'uxc/integration/thirdparty/ListItemBase', 'uxc/integration/thirdparty/List', 'uxc/integration/thirdparty/ListItemCustom', 'uxc/integration/thirdparty/ListItemTemplate', 'uxc/integration/thirdparty/i18n-defaults2', 'uxc/integration/thirdparty/parameters-bundle.css2', 'uxc/integration/thirdparty/Bar', 'uxc/integration/thirdparty/ResponsivePopover', 'uxc/integration/thirdparty/Icons', 'uxc/integration/thirdparty/decline', 'uxc/integration/thirdparty/sys-enter-2', 'uxc/integration/thirdparty/parameters-bundle.css3', 'uxc/integration/thirdparty/i18n-defaults', 'uxc/integration/thirdparty/i18n', 'uxc/integration/thirdparty/LocaleData', 'uxc/integration/thirdparty/getEffectiveScrollbarStyle', 'uxc/integration/thirdparty/FocusableElements', 'uxc/integration/thirdparty/AccessibilityTextsHelper', 'uxc/integration/thirdparty/toLowercaseEnumValue', 'uxc/integration/thirdparty/willShowContent', 'uxc/integration/thirdparty/information', 'uxc/integration/thirdparty/i18n-defaults3', 'uxc/integration/thirdparty/ListItemAdditionalText.css', 'uxc/integration/thirdparty/Dialog'], (function (webcomponentsBase, eventStrict, i18n, parametersBundle_css, query, Popover, Theme, Avatar, Button, Icon, Tag, Title, Text, ListItemBase, List, ListItemCustom, ListItemTemplate, i18nDefaults, parametersBundle_css$1, Bar, ResponsivePopover, Icons, decline, sysEnter2, parametersBundle_css$2, i18nDefaults$1, i18n$1, LocaleData, getEffectiveScrollbarStyle, FocusableElements, AccessibilityTextsHelper, toLowercaseEnumValue, willShowContent, information, i18nDefaults$2, ListItemAdditionalText_css, Dialog) { 'use strict';
    ...
    var panelCss = `.ui5-hidden-text{position:absolute;clip:rect(1px,1px,1px,1px);user-select:none;left:-1000px;top:-1000px;pointer-events:none;font-size:0}:host(:not([hidden])){display:block}:host{font-family:"72override",var(--sapFontFamily);background-color:var(--sapGroup_TitleBackground);border-radius:var(--_ui5-v2-10-0_panel_border_radius)}:host(:not([collapsed])){border-bottom:var(--_ui5-v2-10-0_panel_border_bottom)}:host([fixed]) .ui5-panel-header{padding-left:1rem}.ui5-panel-header{min-height:var(--_ui5-v2-10-0_panel_header_height);width:100%;position:relative;display:flex;justify-content:flex-start;align-items:center;outline:none;box-sizing:border-box;padding-right:var(--_ui5-v2-10-0_panel_header_padding_right);font-family:"72override",var(--sapFontHeaderFamily);font-size:var(--sapGroup_Title_FontSize);font-weight:400;color:var(--sapGroup_TitleTextColor)}.ui5-panel-header-icon{color:var(--_ui5-v2-10-0_panel_icon_color)}.ui5-panel-header-button-animated{transition:transform .4s ease-out}:host(:not([_has-header]):not([fixed])) .ui5-panel-header{cursor:pointer}:host(:not([_has-header]):not([fixed])) .ui5-panel-header:focus:after{content:"";position:absolute;pointer-events:none;z-index:2;border:var(--_ui5-v2-10-0_panel_focus_border);border-radius:var(--_ui5-v2-10-0_panel_border_radius);top:var(--_ui5-v2-10-0_panel_focus_offset);bottom:var(--_ui5-v2-10-0_panel_focus_bottom_offset);left:var(--_ui5-v2-10-0_panel_focus_offset);right:var(--_ui5-v2-10-0_panel_focus_offset)}:host(:not([collapsed]):not([_has-header]):not([fixed])) .ui5-panel-header:focus:after{border-radius:var(--_ui5-v2-10-0_panel_border_radius_expanded)}:host(:not([collapsed])) .ui5-panel-header-button:not(.ui5-panel-header-button-with-icon),:host(:not([collapsed])) .ui5-panel-header-icon-wrapper [ui5-icon]{transform:var(--_ui5-v2-10-0_panel_toggle_btn_rotation)}:host([fixed]) .ui5-panel-header-title{width:100%}.ui5-panel-heading-wrapper.ui5-panel-heading-wrapper-sticky{position:sticky;top:0;background-color:var(--_ui5-v2-10-0_panel_header_background_color);z-index:100;border-radius:var(--_ui5-v2-10-0_panel_border_radius)}.ui5-panel-header-title{width:calc(100% - var(--_ui5-v2-10-0_panel_button_root_width));overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ui5-panel-content{padding:var(--_ui5-v2-10-0_panel_content_padding);background-color:var(--sapGroup_ContentBackground);outline:none;border-bottom-left-radius:var(--_ui5-v2-10-0_panel_border_radius);border-bottom-right-radius:var(--_ui5-v2-10-0_panel_border_radius);overflow:auto}.ui5-panel-header-button-root{display:flex;justify-content:center;align-items:center;flex-shrink:0;width:var(--_ui5-v2-10-0_panel_button_root_width);height:var(--_ui5-v2-10-0_panel_button_root_height);padding:var(--_ui5-v2-10-0_panel_header_button_wrapper_padding);box-sizing:border-box}:host([fixed]:not([collapsed]):not([_has-header])) .ui5-panel-header,:host([collapsed]) .ui5-panel-header{border-bottom:.0625rem solid var(--sapGroup_TitleBorderColor)}:host([collapsed]) .ui5-panel-header{border-bottom-left-radius:var(--_ui5-v2-10-0_panel_border_radius);border-bottom-right-radius:var(--_ui5-v2-10-0_panel_border_radius)}:host(:not([fixed]):not([collapsed])) .ui5-panel-header{border-bottom:var(--_ui5-v2-10-0_panel_default_header_border)}[ui5-button].ui5-panel-header-button{display:flex;justify-content:center;align-items:center;min-width:initial;height:100%;width:100%}.ui5-panel-header-icon-wrapper{display:flex;justify-content:center;align-items:center}.ui5-panel-header-icon-wrapper,.ui5-panel-header-icon-wrapper .ui5-panel-header-icon{color:inherit}.ui5-panel-header-icon-wrapper,[ui5-button].ui5-panel-header-button-with-icon [ui5-icon]{pointer-events:none}.ui5-panel-root{height:100%;display:flex;flex-direction:column}
`;
    ...
    let Panel = Panel_1 = class Panel extends webcomponentsBase.b {
        ...
        get shouldNotAnimate() {
            return this.noAnimation || webcomponentsBase.d$2() === Theme.u.None;
        }
        _headerClick(e) {
    ...
    function UserMenuTemplate() {
        return (parametersBundle_css.jsxs(ResponsivePopover, { id: "user-menu-rp", class: "ui5-user-menu-rp", placement: "Bottom", verticalAlign: "Bottom", horizontalAlign: "End", tabindex: -1, accessibleName: this.accessibleNameText, "aria-labelledby": this.accessibleNameText, open: this.open, opener: this.opener, onClose: this._handlePopoverAfterClose, onOpen: this._handlePopoverAfterOpen, onScroll: this._handleScroll, children: [parametersBundle_css.jsxs(parametersBundle_css.Fragment, { children: [parametersBundle_css.jsxs(Bar, { class: {
    ...
    function headerContent() {
        return (parametersBundle_css.jsx(parametersBundle_css.Fragment, { children: this._selectedAccount &&
                parametersBundle_css.jsxs("div", { class: "ui5-user-menu-selected-account", "aria-labelledby": this._ariaLabelledByAccountInformationText, children: [parametersBundle_css.jsxs(Avatar, { size: "L", onClick: this._handleAvatarClick, initials: this._selectedAccount._initials, fallbackIcon: personPlaceholder, class: "ui5-user-menu--selected-account-avatar", interactive: true, children: [this._selectedAccount.avatarSrc &&
                                    ...
                                    parametersBundle_css.jsx(Tag, { slot: "badge", wrappingType: "None", design: "Set1", colorScheme: "5", title: this._editAvatarTooltip, children: parametersBundle_css.jsx(Icon.Icon, { slot: "icon", name: ListItemTemplate.edit }) })] }), this._selectedAccount.titleText &&
                            parametersBundle_css.jsx(Text, { maxLines: 2, id: "selected-account-title", class: "ui5-user-menu-selected-account-title", children: this._selectedAccount.titleText }), this._selectedAccount.subtitleText &&
                            parametersBundle_css.jsx(Text, { maxLines: 1, class: "ui5-user-menu-selected-account-subtitleText", children: this._selectedAccount.subtitleText }), this._selectedAccount.description &&
                            parametersBundle_css.jsx(Text, { maxLines: 1, class: "ui5-user-menu-selected-account-description", children: this._selectedAccount.description }), this.showManageAccount &&

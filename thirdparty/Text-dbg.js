sap.ui.define(['uxc/integration/thirdparty/webcomponents-fiori', 'uxc/integration/thirdparty/parameters-bundle.css', 'uxc/integration/thirdparty/i18n2', 'uxc/integration/thirdparty/willShowContent', 'uxc/integration/thirdparty/i18n-defaults2', 'uxc/integration/thirdparty/Theme', 'uxc/integration/thirdparty/parameters-bundle.css2', 'uxc/integration/thirdparty/Icons', 'uxc/integration/thirdparty/i18n', 'uxc/integration/thirdparty/LocaleData'], (function (webcomponentsBase, parametersBundle_css, i18n, willShowContent, i18nDefaults, Theme, parametersBundle_css$1, Icons, i18n$1, LocaleData) { 'use strict';
...
`;
    ...
    let Text = Text_1 = class Text extends webcomponentsBase.b {
        ...
        onBeforeRendering() {
            this.style.setProperty(Theme.d$2("--_ui5_text_max_lines"), `${this.maxLines}`);
        }
        get hasText() {

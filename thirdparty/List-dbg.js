sap.ui.define(['exports', 'uxc/integration/thirdparty/webcomponents-fiori', 'uxc/integration/thirdparty/parameters-bundle.css', 'uxc/integration/thirdparty/toLowercaseEnumValue', 'uxc/integration/thirdparty/event-strict', 'uxc/integration/thirdparty/i18n2', 'uxc/integration/thirdparty/Theme', 'uxc/integration/thirdparty/AccessibilityTextsHelper', 'uxc/integration/thirdparty/getEffectiveScrollbarStyle', 'uxc/integration/thirdparty/ListItemBase', 'uxc/integration/thirdparty/parameters-bundle.css2', 'uxc/integration/thirdparty/i18n-defaults2'], (function (exports, webcomponentsBase, parametersBundle_css, toLowercaseEnumValue, eventStrict, i18n, Theme, AccessibilityTextsHelper, getEffectiveScrollbarStyle, ListItemBase, parametersBundle_css$1, i18nDefaults) { 'use strict';
     ...
     * @since 2.0.0
     */
    exports.ListAccessibleRole = void 0;
    ...
    })(exports.ListAccessibleRole || (exports.ListAccessibleRole = {}));
    ...
    })(exports.ListSeparator || (exports.ListSeparator = {}));
...
`;
    ...
    function ListTemplate() {
        return (parametersBundle_css.jsx("div", { class: "ui5-list-root", onFocusIn: this._onfocusin, onKeyDown: this._onkeydown, onDragEnter: this._ondragenter, onDragOver: this._ondragover, onDrop: this._ondrop, onDragLeave: this._ondragleave, "onui5-close": this.onItemClose, "onui5-toggle": this.onItemToggle, "onui5-request-tabindex-change": this.onItemTabIndexChange, "onui5-_focused": this.onItemFocused, "onui5-forward-after": this.onForwardAfter, "onui5-forward-before": this.onForwardBefore, "onui5-selection-requested": this.onSelectionRequested, "onui5-focus-requested": this.onFocusRequested, "onui5-_press": this.onItemPress, children: parametersBundle_css.jsxs(ListItemBase.BusyIndicator, { id: `${this._id}-busyIndicator`, delay: this.loadingDelay, active: this.showBusyIndicatorOverlay, class: "ui5-list-busy-indicator", children: [parametersBundle_css.jsxs("div", { class: "ui5-list-scroll-container", children: [this.header.length > 0 && parametersBundle_css.jsx("slot", { name: "header" }), this.shouldRenderH1 &&
                                ...
                                parametersBundle_css.jsx("div", { id: `${this._id}-after`, tabindex: 0, role: "none", class: "ui5-list-focusarea" }), parametersBundle_css.jsx("span", { tabindex: -1, "aria-hidden": "true", class: "ui5-list-end-marker" })] }), parametersBundle_css.jsx(DropIndicator$1, { orientation: "Horizontal", ownerReference: this })] }) }));
    }
    function moreRow() {
        return (parametersBundle_css.jsx("div", { class: "ui5-growing-button", part: "growing-button", children: parametersBundle_css.jsxs("div", { id: `${this._id}-growing-btn`, role: "button", tabindex: 0, part: "growing-button-inner", class: {
                    ...
                    "ui5-growing-button-inner-active": this._loadMoreActive,
                        ...
                        parametersBundle_css.jsx(ListItemBase.BusyIndicator, { delay: this.loadingDelay, part: "growing-button-busy-indicator", class: "ui5-list-growing-button-busy-indicator", active: true }), parametersBundle_css.jsx("span", { id: `${this._id}-growingButton-text`, class: "ui5-growing-button-text", "growing-button-text": true, children: this._growingButtonText })] }) }));
    }

    Theme.p("@ui5/webcomponents-theming", "sap_horizon", async () => parametersBundle_css.defaultThemeBase);
    Theme.p("@ui5/webcomponents", "sap_horizon", async () => parametersBundle_css$1.defaultTheme);
    var listCss = `.ui5-hidden-text{position:absolute;clip:rect(1px,1px,1px,1px);user-select:none;left:-1000px;top:-1000px;pointer-events:none;font-size:0}.ui5-growing-button{display:flex;align-items:center;padding:var(--_ui5-v2-10-0_load_more_padding);border-top:1px solid var(--sapList_BorderColor);border-bottom:var(--_ui5-v2-10-0_load_more_border-bottom);box-sizing:border-box;cursor:pointer;outline:none}.ui5-growing-button-inner{display:flex;align-items:center;justify-content:center;flex-direction:row;min-height:var(--_ui5-v2-10-0_load_more_text_height);width:100%;color:var(--sapButton_TextColor);background-color:var(--sapList_Background);border:var(--_ui5-v2-10-0_load_more_border);border-radius:var(--_ui5-v2-10-0_load_more_border_radius);box-sizing:border-box}.ui5-growing-button-inner:focus-visible{outline:var(--_ui5-v2-10-0_load_more_outline_width) var(--sapContent_FocusStyle) var(--sapContent_FocusColor);outline-offset:-.125rem;border-color:transparent}.ui5-growing-button-inner:hover{background-color:var(--sapList_Hover_Background)}.ui5-growing-button-inner:active,.ui5-growing-button-inner.ui5-growing-button-inner--active{background-color:var(--sapList_Active_Background);border-color:var(--sapList_Active_Background)}.ui5-growing-button-inner:active>*,.ui5-growing-button-inner.ui5-growing-button-inner--active>*{color:var(--sapList_Active_TextColor)}.ui5-growing-button-text{text-align:center;font-family:"72override",var(--sapFontFamily);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;box-sizing:border-box}.ui5-growing-button-text{height:var(--_ui5-v2-10-0_load_more_text_height);padding:.875rem 1rem 1rem;font-size:var(--_ui5-v2-10-0_load_more_text_font_size);font-weight:700}:host([loading]) .ui5-list-growing-button-busy-indicator:not([_is-busy]){display:none}:host([loading]) .ui5-list-growing-button-busy-indicator[_is-busy]+.ui5-growing-button-text{padding-left:.5rem}:host(:not([hidden])){display:block;max-width:100%;width:100%;-webkit-tap-highlight-color:transparent}:host([indent]) .ui5-list-root{padding:2rem}:host([separators="None"]) .ui5-list-nodata{border-bottom:0}.ui5-list-root,.ui5-list-busy-indicator{width:100%;height:100%;position:relative;box-sizing:border-box}.ui5-list-scroll-container{overflow:auto;height:100%;width:100%}.ui5-list-ul{list-style-type:none;padding:0;margin:0}.ui5-list-ul:focus{outline:none}.ui5-list-focusarea{position:fixed}.ui5-list-header{overflow:hidden;white-space:nowrap;text-overflow:ellipsis;box-sizing:border-box;font-size:var(--sapFontHeader4Size);font-family:"72override",var(--sapFontFamily);color:var(--sapGroup_TitleTextColor);height:3rem;line-height:3rem;padding:0 1rem;background-color:var(--sapGroup_TitleBackground);border-bottom:1px solid var(--sapGroup_TitleBorderColor)}.ui5-list-footer{height:2rem;box-sizing:border-box;-webkit-text-size-adjust:none;font-size:var(--sapFontSize);font-family:"72override",var(--sapFontFamily);line-height:2rem;background-color:var(--sapList_FooterBackground);color:var(--ui5-v2-10-0_list_footer_text_color);padding:0 1rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ui5-list-nodata{list-style-type:none;display:-webkit-box;display:flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:center;justify-content:center;color:var(--sapTextColor);background-color:var(--sapList_Background);border-bottom:1px solid var(--sapList_BorderColor);padding:0 1rem!important;outline:none;min-height:var(--_ui5-v2-10-0_list_no_data_height);font-size:var(--_ui5-v2-10-0_list_no_data_font_size);font-family:"72override",var(--sapFontFamily);position:relative}.ui5-list-nodata:focus:after{content:"";border:var(--sapContent_FocusWidth) var(--sapContent_FocusStyle) var(--sapContent_FocusColor);position:absolute;inset:.125rem;pointer-events:none}.ui5-list-nodata-text{overflow:hidden;text-overflow:ellipsis;white-space:normal;margin:var(--_ui5-v2-10-0_list_item_content_vertical_offset) 0}:host([growing="Scroll"]) .ui5-list-end-marker{display:inline-block}
`;
    ...
    function ListItemGroupHeaderTemplate() {
        return (parametersBundle_css.jsxs("div", { part: "native-li", role: this.effectiveAccRole, tabindex: this.forcedTabIndex ? parseInt(this.forcedTabIndex) : undefined, class: {
                "ui5-ghli-root": true,
                ...this.classes.main,
            }, "aria-label": this.ariaLabelText, "aria-roledescription": this.groupHeaderText, onFocusIn: this._onfocusin, onKeyDown: this._onkeydown, children: [parametersBundle_css.jsx("div", { id: `${this._id}-content`, class: "ui5-li-content", children: parametersBundle_css.jsx("span", { class: "ui5-ghli-title", children: parametersBundle_css.jsx("slot", {}) }) }), this.hasSubItems && parametersBundle_css.jsx("slot", { name: "subItems" })] }));
    }
...
`;
     ...
     */
    exports.List = List_1 = class List extends webcomponentsBase.b {
        constructor() {
            super();
            /**
        ...
        get isDelete() {
            return this.selectionMode === exports.ListSelectionMode.Delete;
        }
        get isSingleSelect() {
            return [
                exports.ListSelectionMode.Single,
                exports.ListSelectionMode.SingleStart,
                exports.ListSelectionMode.SingleEnd,
                exports.ListSelectionMode.SingleAuto,
            ].includes(this.selectionMode);
        }
        get isMultiple() {
            return this.selectionMode === exports.ListSelectionMode.Multiple;
        }
        get ariaLabelledBy() {
        ...
        _getDescriptionForGroups() {
            ...
            if (this._groupCount > 0) {
                if (this.accessibleRole === exports.ListAccessibleRole.List) {
                ...
                else if (this.accessibleRole === exports.ListAccessibleRole.ListBox) {
        ...
        prepareListItems() {
            ...
            slottedItems.forEach((item, key) => {
                ...
                const showBottomBorder = this.separators === exports.ListSeparator.All
                    || (this.separators === exports.ListSeparator.Inner && !isLastChild);
        ...
        */
        onSelectionRequested(e) {
            ...
            if (this.selectionMode !== exports.ListSelectionMode.None && this[`handle${this.selectionMode}`]) {
        ...
        */
        ...
        onItemFocused(e) {
            ...
            if (this.selectionMode === exports.ListSelectionMode.SingleAuto) {
                const detail = {
                    item: target,
        ...
        onItemPress(e) {
            ...
            if (this.selectionMode !== exports.ListSelectionMode.Delete) {
                const detail = {
                    item: pressedItem,
                    selectionComponentPressed: false,
    ...
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "headerText", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "footerText", void 0);
    __decorate([
        webcomponentsBase.s({ type: Boolean })
    ], exports.List.prototype, "indent", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "selectionMode", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "noDataText", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "separators", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "growing", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "growingButtonText", void 0);
    __decorate([
        webcomponentsBase.s({ type: Boolean })
    ], exports.List.prototype, "loading", void 0);
    __decorate([
        webcomponentsBase.s({ type: Number })
    ], exports.List.prototype, "loadingDelay", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "accessibleName", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "accessibleNameRef", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "accessibleDescription", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "accessibleDescriptionRef", void 0);
    __decorate([
        webcomponentsBase.s({ noAttribute: true })
    ], exports.List.prototype, "_associatedDescriptionRefTexts", void 0);
    __decorate([
        webcomponentsBase.s({ noAttribute: true })
    ], exports.List.prototype, "_associatedLabelsRefTexts", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "accessibleRole", void 0);
    __decorate([
        webcomponentsBase.s({ type: Boolean })
    ], exports.List.prototype, "_inViewport", void 0);
    __decorate([
        webcomponentsBase.s({ type: Boolean })
    ], exports.List.prototype, "_loadMoreActive", void 0);
    __decorate([
        webcomponentsBase.s()
    ], exports.List.prototype, "mediaRange", void 0);
    __decorate([
        webcomponentsBase.d({
            type: HTMLElement,
            "default": true,
    ...
    ], exports.List.prototype, "items", void 0);
    __decorate([
        webcomponentsBase.d()
    ], exports.List.prototype, "header", void 0);
    __decorate([
        i18n.i("@ui5/webcomponents")
    ], exports.List, "i18nBundle", void 0);
    exports.List = List_1 = __decorate([
        webcomponentsBase.m({
            tag: "ui5-list",
            fastNavigation: true,
            renderer: parametersBundle_css.d,

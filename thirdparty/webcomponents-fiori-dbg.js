sap.ui.define(['exports', 'uxc/integration/thirdparty/Theme', 'uxc/integration/thirdparty/Icons', 'uxc/integration/thirdparty/i18n', 'uxc/integration/thirdparty/LocaleData'], (function (exports, Theme, Icons, i18n, LocaleData) { 'use strict';
   ...
   */
  var t$7;const i$7=window,s$c=i$7.trustedTypes,e$8=s$c?s$c.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$8="$lit$",n$e=`lit$${(Math.random()+"").slice(9)}$`,l$7="?"+n$e,h=`<${l$7}>`,r$5=document,u$4=()=>r$5.createComment(""),d$3=t=>null===t||"object"!=typeof t&&"function"!=typeof t,c$7=Array.isArray,v$3=t=>c$7(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),a$8="[ \t\n\f\r]",f$5=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_=/-->/g,m$5=/>/g,p$3=RegExp(`>|${a$8}(?:([^\\s"'>=/]+)(${a$8}*=${a$8}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$2=/'/g,$=/"/g,y$3=/^(?:script|style|textarea|title)$/i,w$1=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$1=w$1(1),b$7=w$1(2),T$1=Symbol.for("lit-noChange"),A$1=Symbol.for("lit-nothing"),E=new WeakMap,C$1=r$5.createTreeWalker(r$5,129,null,false);function P$1(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e$8?e$8.createHTML(i):i}const V$1=(t,i)=>{const s=t.length-1,e=[];let l,r=2===i?"<svg>":"",u=f$5;for(let i=0;i<s;i++){const s=t[i];let d,c,v=-1,a=0;for(;a<s.length&&(u.lastIndex=a,c=u.exec(s),null!==c);)a=u.lastIndex,u===f$5?"!--"===c[1]?u=_:void 0!==c[1]?u=m$5:void 0!==c[2]?(y$3.test(c[2])&&(l=RegExp("</"+c[2],"g")),u=p$3):void 0!==c[3]&&(u=p$3):u===p$3?">"===c[0]?(u=null!=l?l:f$5,v=-1):void 0===c[1]?v=-2:(v=u.lastIndex-c[2].length,d=c[1],u=void 0===c[3]?p$3:'"'===c[3]?$:g$2):u===$||u===g$2?u=p$3:u===_||u===m$5?u=f$5:(u=p$3,l=void 0);const w=u===p$3&&t[i+1].startsWith("/>")?" ":"";r+=u===f$5?s+h:v>=0?(e.push(d),s.slice(0,v)+o$8+s.slice(v)+n$e+w):s+n$e+(-2===v?(e.push(void 0),i):w);}return [P$1(t,r+(t[s]||"<?>")+(2===i?"</svg>":"")),e]};class N{constructor({strings:t,_$litType$:i},e){let h;this.parts=[];let r=0,d=0;const c=t.length-1,v=this.parts,[a,f]=V$1(t,i);if(this.el=N.createElement(a,e),C$1.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(h=C$1.nextNode())&&v.length<c;){if(1===h.nodeType){if(h.hasAttributes()){const t=[];for(const i of h.getAttributeNames())if(i.endsWith(o$8)||i.startsWith(n$e)){const s=f[d++];if(t.push(i),void 0!==s){const t=h.getAttribute(s.toLowerCase()+o$8).split(n$e),i=/([.?@])?(.*)/.exec(s);v.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?H$1:"?"===i[1]?L:"@"===i[1]?z:k$1});}else v.push({type:6,index:r});}for(const i of t)h.removeAttribute(i);}if(y$3.test(h.tagName)){const t=h.textContent.split(n$e),i=t.length-1;if(i>0){h.textContent=s$c?s$c.emptyScript:"";for(let s=0;s<i;s++)h.append(t[s],u$4()),C$1.nextNode(),v.push({type:2,index:++r});h.append(t[i],u$4());}}}else if(8===h.nodeType)if(h.data===l$7)v.push({type:2,index:r});else {let t=-1;for(;-1!==(t=h.data.indexOf(n$e,t+1));)v.push({type:7,index:r}),t+=n$e.length-1;}r++;}}static createElement(t,i){const s=r$5.createElement("template");return s.innerHTML=t,s}}function S$1(t,i,s=t,e){var o,n,l,h;if(i===T$1)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d$3(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,false),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=S$1(t,r._$AS(t,i.values),r,e)),i}class M{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:r$5).importNode(s,true);C$1.currentNode=o;let n=C$1.nextNode(),l=0,h=0,u=e[0];for(;void 0!==u;){if(l===u.index){let i;2===u.type?i=new R$1(n,n.nextSibling,this,t):1===u.type?i=new u.ctor(n,u.name,u.strings,this,t):6===u.type&&(i=new Z$1(n,this,t)),this._$AV.push(i),u=e[++h];}l!==(null==u?void 0:u.index)&&(n=C$1.nextNode(),l++);}return C$1.currentNode=r$5,o}v(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}}let R$1 = class R{constructor(t,i,s,e){var o;this.type=2,this._$AH=A$1,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cp=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===(null==t?void 0:t.nodeType)&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=S$1(this,t,i),d$3(t)?t===A$1||null==t||""===t?(this._$AH!==A$1&&this._$AR(),this._$AH=A$1):t!==this._$AH&&t!==T$1&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v$3(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==A$1&&d$3(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$5.createTextNode(t)),this._$AH=t;}g(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=N.createElement(P$1(e.h,e.h[0]),this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.v(s);else {const t=new M(o,this),i=t.u(this.options);t.v(s),this.$(i),this._$AH=t;}}_$AC(t){let i=E.get(t.strings);return void 0===i&&E.set(t.strings,i=new N(t)),i}T(t){c$7(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new R(this.k(u$4()),this.k(u$4()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cp=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let k$1 = class k{constructor(t,i,s,e,o){this.type=1,this._$AH=A$1,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$1;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=S$1(this,t,i,0),n=!d$3(t)||t!==this._$AH&&t!==T$1,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=S$1(this,e[s+l],i,l),h===T$1&&(h=this._$AH[l]),n||(n=!d$3(h)||h!==this._$AH[l]),h===A$1?t=A$1:t!==A$1&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===A$1?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};let H$1 = class H extends k$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$1?void 0:t;}};const I$1=s$c?s$c.emptyScript:"";class L extends k$1{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==A$1?this.element.setAttribute(this.name,I$1):this.element.removeAttribute(this.name);}}class z extends k$1{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=S$1(this,t,i,0))&&void 0!==s?s:A$1)===T$1)return;const e=this._$AH,o=t===A$1&&e!==A$1||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==A$1&&(e===A$1||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}let Z$1 = class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){S$1(this,t);}};const B$1=i$7.litHtmlPolyfillSupport;null==B$1||B$1(N,R$1),(null!==(t$7=i$7.litHtmlVersions)&&void 0!==t$7?t$7:i$7.litHtmlVersions=[]).push("2.8.0");

  /**
   * @license
   * Copyright 2020 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const e$7=Symbol.for(""),l$6=t=>{if((null==t?void 0:t.r)===e$7)return null==t?void 0:t._$litStatic$},o$7=t=>({_$litStatic$:t,r:e$7}),s$b=new Map,a$7=t=>(r,...e)=>{const o=e.length;let i,a;const n=[],u=[];let c,$=0,f=false;for(;$<o;){for(c=r[$];$<o&&void 0!==(a=e[$],i=l$6(a));)c+=i+r[++$],f=true;$!==o&&u.push(a),n.push(c),$++;}if($===o&&n.push(r[o]),f){const t=n.join("$$lit$$");void 0===(r=s$b.get(t))&&(n.raw=n,s$b.set(t,r=n)),e=u;}return t(r,...e)},n$d=a$7(x$1),u$3=a$7(b$7);

  let t$6 = class t{static{this.html=n$d;}static{this.svg=u$3;}static{this.unsafeStatic=o$7;}};Theme.s("LitStatic",t$6);
  ...
  const n$c=(r,c,a)=>{let o,l;return f$4({beforeStart:()=>{o=r.scrollLeft,l=r.scrollTop;},duration:v$2,element:r,advance:t=>{r.scrollLeft=o+t*c,r.scrollTop=l+t*a;}})};
  ...
  const u$2=o=>{let i,a,r,d,n,s,p,g,e,l,y,m;const h=f$4({beforeStart:()=>{const t=o;i=getComputedStyle(t),a=parseFloat(i.paddingTop),r=parseFloat(i.paddingBottom),d=parseFloat(i.marginTop),n=parseFloat(i.marginBottom),s=parseFloat(i.height),p=t.style.overflow,g=t.style.paddingTop,e=t.style.paddingBottom,l=t.style.marginTop,y=t.style.marginBottom,m=t.style.height,t.style.overflow="hidden";},duration:v$2,element:o,advance:t=>{o.style.paddingTop=`${a-a*t}px`,o.style.paddingBottom=`${r-r*t}px`,o.style.marginTop=`${d-d*t}px`,o.style.marginBottom=`${n-n*t}px`,o.style.height=`${s-s*t}px`;}});return h.promise().then(t=>{t instanceof Error||(o.style.overflow=p,o.style.paddingTop=g,o.style.paddingBottom=e,o.style.marginTop=l,o.style.marginBottom=y,o.style.height=m,o.style.display="none");}),h};

  let n$b;Theme.i$2(()=>{n$b=void 0;});const d$2=()=>(n$b===void 0&&(n$b=Theme.C$1()),n$b),m$4=o=>{Object.values(Theme.u).includes(o)&&(n$b=o);};

  var s$a=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$a||{});

  let n$a;Theme.i$2(()=>{n$a=void 0;});const i$6=()=>(n$a===void 0&&(n$a=Theme.I()),n$a&&n$a in s$a?n$a:s$a.Gregorian);

  let t$4;let a$5 = class a{static getLegacyDateCalendarCustomizing(){return t$4===void 0&&(t$4=Theme.M()),t$4.legacyDateCalendarCustomizing||[]}};Theme.s("LegacyDateFormats",a$5);

  let e$6;Theme.i$2(()=>{e$6=void 0;});const n$9=()=>(e$6===void 0&&(e$6=Theme.M()),e$6.firstDayOfWeek),i$5=Theme.n("LegacyDateFormats"),m$3=i$5?a$5.getLegacyDateCalendarCustomizing:()=>[];

  const c$6=["value-changed","click"];let e$5;Theme.i$2(()=>{e$5=void 0;});const s$9=t=>c$6.includes(t),l$5=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$5===void 0&&(e$5=Theme.U()),e$5),f$3=t=>{e$5=t;},a$4=t=>{const n=o$6();return s$9(t)?false:n===true?true:!l$5(t)};

  const m$2=(a={})=>e=>{if(Object.prototype.hasOwnProperty.call(e,"metadata")||(e.metadata={}),typeof a=="string"){e.metadata.tag=a;return}const{tag:i,languageAware:o,themeAware:r,cldr:s,fastNavigation:l,formAssociated:n,shadowRootOptions:d}=a;e.metadata.tag=i,o&&(e.metadata.languageAware=o),s&&(e.metadata.cldr=s),r&&(e.metadata.themeAware=r),l&&(e.metadata.fastNavigation=l),n&&(e.metadata.formAssociated=n),d&&(e.metadata.shadowRootOptions=d),["renderer","template","styles","dependencies"].forEach(t=>{a[t]&&Object.defineProperty(e,t,{get:()=>a[t]});});};
  ...
  const y$2={BACKSPACE:8,TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,ARROW_LEFT:37,ARROW_UP:38,ARROW_RIGHT:39,ARROW_DOWN:40,DELETE:46,NUMPAD_PLUS:107,NUMPAD_MINUS:109,F4:115,F10:121,PLUS:187,MINUS:219},b$4=o=>(o.key?o.key==="Enter":o.keyCode===y$2.ENTER)&&!a$3(o),d=o=>(o.key?o.key==="Enter":o.keyCode===y$2.ENTER)&&e$4(o,false,false,true),f$2=o=>e$4(o,true,false,false),i$4=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$2.SPACE)&&!a$3(o),A=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$2.SPACE)&&e$4(o,false,false,true),K=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$2.ARROW_LEFT)&&!a$3(o),c$5=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$2.ARROW_RIGHT)&&!a$3(o),D=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$2.ARROW_UP)&&!a$3(o),P=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$2.ARROW_DOWN)&&!a$3(o),O$1=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$2.ARROW_UP)&&e$4(o,false,false,true),u$1=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$2.ARROW_DOWN)&&e$4(o,false,false,true),w=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$2.ARROW_LEFT)&&e$4(o,false,false,true),T=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$2.ARROW_RIGHT)&&e$4(o,false,false,true),F=o=>(o.key?o.key==="Home":o.keyCode===y$2.HOME)&&!a$3(o),W=o=>(o.key?o.key==="End":o.keyCode===y$2.END)&&!a$3(o),H=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$2.ESCAPE)&&!a$3(o),B=o=>(o.key?o.key==="Tab":o.keyCode===y$2.TAB)&&!a$3(o),m$1=o=>(o.key?o.key==="Tab":o.keyCode===y$2.TAB)&&e$4(o,false,false,true),x=o=>(o.key?o.key==="Backspace":o.keyCode===y$2.BACKSPACE)&&!a$3(o),V=o=>(o.key?o.key==="Delete":o.keyCode===y$2.DELETE)&&!a$3(o),Y=o=>(o.key?o.key==="PageUp":o.keyCode===y$2.PAGE_UP)&&!a$3(o),Z=o=>(o.key?o.key==="PageDown":o.keyCode===y$2.PAGE_DOWN)&&!a$3(o),yo=o=>(o.key?o.key==="+":o.keyCode===y$2.PLUS)||o.keyCode===y$2.NUMPAD_PLUS&&!a$3(o),eo=o=>(o.key?o.key==="-":o.keyCode===y$2.MINUS)||o.keyCode===y$2.NUMPAD_MINUS&&!a$3(o),ao=o=>o.key?s$7(o)||fo(o):o.keyCode===y$2.F4&&!a$3(o)||o.keyCode===y$2.ARROW_DOWN&&e$4(o,false,true,false),so=o=>o.key==="F2"&&!a$3(o),s$7=o=>o.key==="F4"&&!a$3(o),ro=o=>(o.key?o.key==="F10":o.keyCode===y$2.F10)&&e$4(o,false,false,true),fo=o=>(o.key==="ArrowDown"||o.key==="Down"||o.key==="ArrowUp"||o.key==="Up")&&e$4(o,false,true,false),io=o=>o.key==="Shift"||o.keyCode===y$2.SHIFT,a$3=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey),e$4=(o,r,l,E)=>o.shiftKey===E&&o.altKey===l&&k(o)===r;
  ...
  const s$1=["disabled","title","hidden","role","draggable"],r=e=>s$1.includes(e)||e.startsWith("aria")?true:![HTMLElement,Element,Node].some(t=>t.prototype.hasOwnProperty(e));
  ...
  var PackageModule = /*#__PURE__*/Object.freeze({
    ...
    I18nBundle: Icons.u$1,
    ItemNavigation: f$1,
    MediaRange: i,
    RegisteredIconCollection: Icons.t,
    ResizeHandler: f,
    ScrollEnablement: v,
    UI5Element: b$1,
    ...
    registerI18nLoader: i18n.$,
    registerIconLoader: Icons.T,
    registerLocaleDataLoader: LocaleData.C,
    registerThemePropertiesLoader: Theme.p,
    renderDeferred: Theme.l$2,
    renderFinished: Theme.f,
    renderImmediately: Theme.c$2,
    sanitizeHTML: fnSanitizeHTML,
    scroll: n$c,
    setAnimationMode: m$4,
    setCustomElementsScopingRules: Theme.p$1,
    setCustomElementsScopingSuffix: Theme.l$4,
    setDefaultIconCollection: Icons.e,
    setFetchDefaultLanguage: i18n.L,
    setLanguage: i18n.s$1,
    setNoConflict: f$3,
    setTheme: Theme.u$1,
    slideDown: b$6,
    slideUp: u$2,
    slot: d$1,
    supportsTouch: Theme.l$3
  });
